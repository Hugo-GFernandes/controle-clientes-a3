...
-- Inserção de dados iniciais para tabela de status de atendimento
-- Inserção de dados ficticios para testes

-- Dados iniciais para tabela de status de atendimento do cliente. Necessários para o funcionamento dos status.
...
-- Dados ficticios para teste das demais operações (tabela Cliente)
...
-- Dados ficticios para teste das demais operações (tabela Anotacao)
...
-- Dados ficticios para teste das demais operações (tabela Lembrete)
